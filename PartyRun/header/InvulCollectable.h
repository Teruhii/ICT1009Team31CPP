...
class InvulCollectable : public Collectable
{
public:
	InvulCollectable(sf::Texture* texture, sf::Vector2f spriteScaling,
	...
	Body& getBody() { return *(this->invulBody); }
private:
	// --- Variables ---
	...
	// --- Texture ---
	sf::Texture invulTexture;
	sf::Sprite invulSprite;

	// --- Physics variables ---
	sf::RectangleShape* invulBodyShape;
	Body* invulBody;
};
